...
def main():
    ...
    while True:
        ...
        if j == 0:  # 如果是第一个数
            ...
            r = 20 / 0.001 if (20 / 0.001) < (25 - passed_coordinates[j ][5] ) / 0.001 else (25 - passed_coordinates[j][
                5] ) / 0.001
            flag = 0
        elif j % 2 == 0:  # 偶数为垂直
            r = 15 / 0.001 if (15 / 0.001) < (25 - passed_coordinates[j ][4] ) / 0.001 else (25 - passed_coordinates[j ][
                4] ) / 0.001
            flag = 1
